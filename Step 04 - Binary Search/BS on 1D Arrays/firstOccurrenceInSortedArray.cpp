/*
Problem Statement: Given a sorted array of N integers, write a program to find the index of the first occurrence of the target key. If the target is not found then return -1.
